Pod::Spec.new do |s|
  ...
  s.subspec 'Network' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Network/LLNetwork.h"
  ...
  s.subspec 'Log' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Log/LLLog.h"
  ...
  s.subspec 'Crash' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Crash/LLCrash.h"
  ...
  s.subspec 'AppInfo' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/AppInfo/LLAppInfo.h"
  ...
  s.subspec 'Sandbox' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Sandbox/LLSandbox.h"
  ...
  s.subspec 'Screenshot' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Screenshot/LLScreenshot.h"
  ...
  s.subspec 'Hierarchy' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Hierarchy/LLHierarchy.h"
  ...
  s.subspec 'Magnifier' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Magnifier/LLMagnifier.h"
  ...
  s.subspec 'Ruler' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Ruler/LLRuler.h"
  ...
  s.subspec 'WidgetBorder' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/WidgetBorder/LLWidgetBorder.h"
  ...
  s.subspec 'Html' do |ss|
    ss.public_header_files      = "LLDebugTool/DebugTool/*.h", "LLDebugTool/Core/Component/Html/LLHtml.h"
    ss.source_files             = "LLDebugTool/DebugTool/*.{h,m}", "LLDebugTool/Core/Component/Html/**/*.{h,m}", "LLDebugTool/Core/Others/**/*.{h,m}"
    ss.resources                = "LLDebugTool/Components/Html/**/*.{xib,storyboard,bundle}", "LLDebugTool/Core/Others/**/*.{xib,storyboard,bundle}"
